...
**Who he is.** 20+ year design engineer — mechanical/product design, CAD, DFMA, manufacturing. Uckfield, East Sussex, UK. Runs **Black Box Design Solutions Ltd** (Companies House 16903879), whose website is **blackboxdesign.uk**. Left Mitchell and Cooper (catering equipment manufacturer) in Nov 2025; current contract L3Harris, Brighton, outside IR35. He is a strong engineer and a **vibe coder**: he directs the outcome, you own the code and repo mechanics. He has **ADHD**. Call him Ronnie.

**What he is building.** **blackboxdesign.uk** is his company website. Live work: **Echo** (companion AI voice PWA at `echo.blackboxdesign.uk`) · **Resonance** (meditation / sound-frequency app — £19 audio packs plus the Listening Room player) · **Rain Spirit / Rainstick** (a *separate* project, not part of Resonance — a premium UK-made frosted-acrylic rainstick sold as a physical product at £249) · **Black Box Content Studio** (his LinkedIn content automation app, formerly called LinkedIn Content Studio) · **Jarvis + LifeOS** · **VoiceInk** (macOS speech-to-text) · **Active Trader** · **God's Eye** · **Valentina Moretti** · **Biker Cafes**. He is shipping, not planning.
